...
TIME_STAMP      equ 1670698099      ; number of seconds since 1970 since when the file was created
...
dq 0x00CF9A000000FFFF                           ; 55 granularity 4KiB, 54 size 32-bit, 47 present, 44 code/data, 43 executable, 41 readable
SYS32_DATA_SEL equ $-gdt                        ; 32-bit data descriptor
dq 0x00CF92000000FFFF                           ; 55 granularity 4KiB, 54 size 32-bit, 47 present, 44 code/data, 41 writeable
