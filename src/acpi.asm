...
; //                                                                          //
; // Details:  this file contains the acpi code                               //
...
init_ACPI:
	...
	cmp al, 'U'
	je ACPI_from_UEFI
	mov esi, 0x000E0000             ; start looking for the RSD (root system description)
	mov rbx, 'RSD PTR '             ; this in the signature for the ACPI table: (0x2052545020445352) TODO: valid?
